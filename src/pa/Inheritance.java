...
//            pa.add("noun",from.getOrigin().getTitle(), to.getOrigin().getAddress() + "^is");
//        } else {
...
//            pa.add("noun", from.getOrigin().getTitle() ,to.getOrigin().getAddress() + "^is"); //add info
//        } else{
//            if(  !to.getOrigin().getChild("^is").contains(from.getOrigin().getTitle())){
//                pa.add("noun", from.getOrigin().getTitle() ,to.getOrigin().getAddress() + "^is");
//            }
//        }
//
...
//            pa.add("noun",to.getOrigin().getTitle(), from.getOrigin().getAddress() + "^logicalchild"); //add info
//        }else{
//            //Check if contains information already..
//            if( !from.getChildrenOfDimension("^logicalchild").contains(to.getOrigin().getTitle())  ){
//                pa.add("noun",to.getOrigin().getTitle(), from.getOrigin().getAddress() + "^logicalchild");
//            }
//        }
//
//
//
//        //pa.add( from.getOrigin().getTitle() ,to.getOrigin().getAddress() + "^is");
//    }
//
//    /**
//     *            EX1           EX2
...
//        }
//        //System.out.println("BN: "+ BNx.getOrigin().getTitle());
//
//
//    }
//
