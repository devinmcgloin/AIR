...
public class Scanner {
    ...
    /**
     * any node that contain the logical parent, or the logical parent / logical child may need restructuring. Make sure
     * LC is strctured under LP. Has to go thru each key val pair to ensure that all the keys match up with proper
     * values or are left blank.
     *
     * @param LP
     * @param LC
     */
